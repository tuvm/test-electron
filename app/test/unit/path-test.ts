  ...
  describe('encodePathAsUrl', () => {
    if (__WIN32__) {
      it('normalizes path separators on Windows', () => {
        const dirName =
          'C:/Users/shiftkey\\AppData\\Local\\VinpearlOCR\\app-1.0.4\\resources\\app'
      ...
      it('encodes spaces and hashes', () => {
        const dirName =
          'C:/Users/The Kong #2\\AppData\\Local\\VinpearlOCR\\app-1.0.4\\resources\\app'
    ...
    if (__DARWIN__ || __LINUX__) {
      it('encodes spaces and hashes', () => {
        const dirName =
          '/Users/The Kong #2\\AppData\\Local\\VinpearlOCR\\app-1.0.4\\resources\\app'
        const uri = encodePathAsUrl(dirName, 'index.html')
